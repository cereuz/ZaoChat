 ...
 */
public class ChatFragmentAdapter extends RecyclerView.Adapter<ChatFragmentAdapter.BaseAdapter> {
    ...
    @Override
    public ChatFragmentAdapter.BaseAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(ChatFragmentAdapter.BaseAdapter holder, int position) {
